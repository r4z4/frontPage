...
rotate(){
  ...
  spin() {
    ...
    let className2 = "frontPageDivImage";
    this.setState({imageClass: className});
    setTimeout(() => { this.setState({imageClass: className2 }); }, 2000);
  };
  ...
  handleCheckboxChange(event) {
    ...
    switch(name) {
      ...
      case "isDefaultImage":
        ...
        this.setState({
          selectedFile: consts.defaultImage
          })
        : this.setState({
          selectedFile: null
          })
